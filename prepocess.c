     ...
     {	
          ...
          else
          {
               while(!feof(prb_file))
               {
                    ...
                    /***************$Z_AXIS_DIRECTION*************/
                    if (strcmp(message,"$Z_AXIS_DIRECTION")==0)
                    {
                         fscanf(prb_file,"%d",&ZDirection);
                    }
                    ...
                    /***************$PHYSICAL_AREA_MU*****************/
                    if (strcmp(message,"$PHYSICAL_AREA_MU")==0)
                    {
                         fscanf(prb_file,"%d",&phy_mu_num);
                         phy_mu=(double*) malloc( (phy_mu_num+1)*sizeof(double) );
          
                         for (i=1;i<=phy_mu_num;i++)
                         {
                              fscanf(prb_file,"%d%lf",&temp,&phy_mu[i]);
                         }
          
                         fscanf(prb_file,"%s",message);
                         if (strcmp(message,"$END_PHY")!=0)
                         {
                              printf("PHY_MU data read error!\n");
                              exit(-1);
                         }
                    }
                    
                    /***************$Anisotropicc*****************/
                    if (strcmp(message,"$Anisotropicc")==0)
                    {
                         fscanf(prb_file,"%d",&anisoc.AnisoNumber);
                         printf("anisoc.AnisoNumber=%d\n",anisoc.AnisoNumber);
                         ...
                         {
                              fscanf(prb_file,"%s%d",message,&anisoc.areaindex[i]);
                              fscanf(prb_file,"%s%lf",message,&anisoc.value[3*(i-1)+1]);
                              fscanf(prb_file,"%s%lf",message,&anisoc.value[3*(i-1)+2]);
                              fscanf(prb_file,"%s%lf",message,&anisoc.value[3*(i-1)+3]);
                              fscanf(prb_file,"%s%lf",message,&anisoc.angle[3*(i-1)+1]);
                              fscanf(prb_file,"%s%lf",message,&anisoc.angle[3*(i-1)+2]);
                              fscanf(prb_file,"%s%lf",message,&anisoc.angle[3*(i-1)+3]);
                         }
                         fscanf(prb_file,"%s",message);
                         if (strcmp(message,"$END_Anicc")!=0)
                         {
                              printf("Anisotropicc data read error!\n");
                              exit(-1);
                         }
                    }
                    /***************$Anisotropicm*****************/
                    if (strcmp(message,"$Anisotropicm")==0)
                    {
                         fscanf(prb_file,"%d",&anisom.AnisoNumber);
                         ...
                         {
                              fscanf(prb_file,"%s%d",message,&anisom.areaindex[i]);
                              fscanf(prb_file,"%s%lf",message,&anisom.value[3*(i-1)+1]);
                              fscanf(prb_file,"%s%lf",message,&anisom.value[3*(i-1)+2]);
                              fscanf(prb_file,"%s%lf",message,&anisom.value[3*(i-1)+3]);
                              fscanf(prb_file,"%s%lf",message,&anisom.angle[3*(i-1)+1]);
                              fscanf(prb_file,"%s%lf",message,&anisom.angle[3*(i-1)+2]);
                              fscanf(prb_file,"%s%lf",message,&anisom.angle[3*(i-1)+3]);
                         }
                         fscanf(prb_file,"%s",message);
                         if (strcmp(message,"$END_Anicm")!=0)
                         {
                              printf("Anisotropicm data read error!\n");
                              exit(-1);
                         }
                    }
